...
<head>
  ...
  <title>Metro Hair Salon & Spa</title>
...
<div class="site-container">
  <div class="section no-pad-bot z-depth-1" style="background-color: #eee;">
  <div class="container">
  <div class="row center">  
	  <div class="col s12">
	  <h3 class="header center light" style="letter-spacing: 5px; color: #2d3034;">SPA SERVICES</h3>
	  </div>
	  </div>
	  <div class="row center">  
	  <div class="col s12">	  
	  <table class="highlight">
        ...
        <tbody>
          <tr>
            <td>Manicure (French add $10)</td>
            <td>$24+</td>
          </tr>
          <tr>
            <td>Pedicure (French add $10)</td>
            <td>$35+</td>
          </tr>
          <tr>
            <td>Gel Manicure (French add $10)</td>
            <td>$35+</td>
          </tr>
          <tr>
            <td>Gel Pedicure (French add $10)</td>
            <td>$45+</td>
          </tr>
          <tr>
            <td>Eyebrows Waxing</td>
            <td>$15+</td>
          </tr>
          <tr>
            <td>Chin or Lip Waxing</td>
            <td>$12+</td>
          </tr>
          <tr>
            <td>Eyebrow Chin & Lip Waxing Combo</td>
            <td>$36+</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Half Leg Waxing (Knee & below)</td>
            <td>$43+</td>
          </tr>		  
          <tr>
          ...
          <tr>
            <td>Men's Chest or Back Waxing</td>
            <td>$60+</td>
          </tr>
          <tr>
            <td>Ultrasound Facial</td>
            <td>$125</td>
          </tr>		
          <tr>
            <td>Ultrasound Facial Series of 4</td>
            <td>$375</td>
          </tr>
          <tr>
            <td>Ultrasound Maintenance Series of 4</td>
            <td>$300</td>
          </tr>
          <tr>
            <td>Dermafile Facial (Includes serum, moist & sunblock)</td>
            <td>$65</td>
          </tr>	
          <tr>
            <td>Dermafile Facial Series of 3</td>
            <td>$162.50</td>
          </tr>
          <tr>
            <td>European Facial</td>
            <td>$69+</td>
          </tr>
          <tr>
            <td>Rosacea Facial w/ Cool Stones</td>
            <td>$60</td>
          </tr>
          <tr>
            <td>Men's Facial w/ Warm Stones</td>
            <td>$60</td>
          </tr>		
          <tr>
          ...
          <tr>
            <td>Eyebrow or Lash Tint (Each)</td>
            <td>$15</td>
          </tr>		
          <tr>
            <td>Eyebrow & Lash Tint (Each)</td>
            <td>$25</td>
          </tr>			  
        </tbody>
      </table>	  
